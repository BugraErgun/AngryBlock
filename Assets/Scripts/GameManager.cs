...
{
    private ShotCount shotCountText;
    ...
    private void Awake()
    {
        scoreTextInGame= GameObject.Find("Score").GetComponent<TextMeshProUGUI>();
        shotCountText = GameObject.Find("ShotCountText").GetComponent<ShotCount>();
    ...
    private void Start()
    {
        ...
        Physics2D.gravity = new Vector2(0, -17f);
    ...
    private void Update()
    {
        ...
        CheckBlocks();
        scoreTextInGame.text = scoree.ToString();
    }
    ...
    public void CheckShotCount()
    {
        if (shotCount == 1 )
        {
            shotCountText.SetTopText("SHOOT");
        ...
        {
            shotCountText.SetTopText("SHOOT");
            shotCountText.SetBottomText("3/3");
            shotCountText.Flash();
        }
    }
}
